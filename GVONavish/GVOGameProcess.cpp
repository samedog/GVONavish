...
// For image analysis debugging GVOGameProcess
...
#ifndef NDEBUG
	// Automatic navigation variable for debugging
...
bool GVOGameProcess::updateState()
{
	...
	if ( s_debugAutoCruiseEnabled ) {
		...
		//// Confirmation debugging code of processing the map
